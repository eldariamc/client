...
public class ItemArmor extends Item
{
    ...
    public boolean hasEffect(ItemStack p_77636_1_) {
        return super.hasEffect(p_77636_1_) || this == Items.exploration_boots;
    }
    ...
    public enum ArmorMaterial
    {
        ...
        ZINC(65, new int[]{6, 16, 12, 6}, 10),
        CRONYXE(80, new int[]{7, 19, 15, 7}, 14),
        KOBALT(90, new int[]{8, 22, 16, 8}, 18),
        ELDARIUM(110, new int[]{10, 27, 20, 10}, 28);
