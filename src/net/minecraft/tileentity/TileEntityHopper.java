...
public class TileEntityHopper extends TileEntity implements IHopper
{
    ...
    private IInventory func_145895_l()
    {
        ...
        return func_145893_b(this.getWorldObj(), (double)(this.posX + Facing.offsetsXForSide[var1]), (double)(this.posY + Facing.offsetsYForSide[var1]), (double)(this.posZ + Facing.offsetsZForSide[var1]));
    }
