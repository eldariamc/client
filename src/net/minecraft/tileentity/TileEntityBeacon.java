...
public class TileEntityBeacon extends TileEntity implements IInventory
{
    ...
    private void func_146000_x()
    {
        if (this.field_146015_k && this.field_146012_l > 0 && !this.worldObj.isClient && this.field_146013_m > 0)
        {
            ...
            AxisAlignedBB var4 = AxisAlignedBB.getBoundingBox((double)this.posX, (double)this.posY, (double)this.posZ, (double)(this.posX + 1), (double)(this.posY + 1), (double)(this.posZ + 1)).expand(var1, var1, var1);
    ...
    private void func_146003_y()
    {
        ...
        if (!this.worldObj.canBlockSeeTheSky(this.posX, this.posY + 1, this.posZ))
        {
        ...
        else
        {
            ...
            for (int var2 = 1; var2 <= 4; this.field_146012_l = var2++)
            {
                ...
                for (int var5 = this.posX - var2; var5 <= this.posX + var2 && var4; ++var5)
                {
                    for (int var6 = this.posZ - var2; var6 <= this.posZ + var2; ++var6)
                    {
        ...
        {
            Iterator var8 = this.worldObj.getEntitiesWithinAABB(EntityPlayer.class, AxisAlignedBB.getBoundingBox((double)this.posX, (double)this.posY, (double)this.posZ, (double)this.posX, (double)(this.posY - 4), (double)this.posZ).expand(10.0D, 5.0D, 10.0D)).iterator();
    ...
    public Packet getDescriptionPacket()
    {
        ...
        return new S35PacketUpdateTileEntity(this.posX, this.posY, this.posZ, 3, var1);
    }
