...
public class TileEntityEnchantmentTable extends TileEntity
{
    ...
    public void updateEntity()
    {
        ...
        EntityPlayer var1 = this.worldObj.getClosestPlayer((double)((float)this.posX + 0.5F), (double)((float)this.posY + 0.5F), (double)((float)this.posZ + 0.5F), 3.0D);

        if (var1 != null)
        {
            double var2 = var1.posX - (double)((float)this.posX + 0.5F);
            double var4 = var1.posZ - (double)((float)this.posZ + 0.5F);
