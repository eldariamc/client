...
public class Items
{
    ...
    public static final Item spruce_door = (Item)Item.itemRegistry.getObject("spruce_door");
    public static final Item birch_door = (Item)Item.itemRegistry.getObject("birch_door");
    public static final Item jungle_door = (Item)Item.itemRegistry.getObject("jungle_door");
    public static final Item acacia_door = (Item)Item.itemRegistry.getObject("acacia_door");
    public static final Item dark_oak_door = (Item)Item.itemRegistry.getObject("dark_oak_door");
    ...
    public static final Item zinc_axe = (Item)Item.itemRegistry.getObject("zinc_axe");
    public static final Item zinc_hoe = (Item)Item.itemRegistry.getObject("zinc_hoe");
    public static final Item kobalt_sword = (Item)Item.itemRegistry.getObject("kobalt_sword");
    public static final Item kobalt_pickaxe = (Item)Item.itemRegistry.getObject("kobalt_pickaxe");
    public static final Item kobalt_shovel = (Item)Item.itemRegistry.getObject("kobalt_shovel");
    public static final Item kobalt_axe = (Item)Item.itemRegistry.getObject("kobalt_axe");
    public static final Item kobalt_hoe = (Item)Item.itemRegistry.getObject("kobalt_hoe");
    public static final Item cronyxe_sword = (Item)Item.itemRegistry.getObject("cronyxe_sword");
    public static final Item cronyxe_pickaxe = (Item)Item.itemRegistry.getObject("cronyxe_pickaxe");
    public static final Item cronyxe_shovel = (Item)Item.itemRegistry.getObject("cronyxe_shovel");
    public static final Item cronyxe_axe = (Item)Item.itemRegistry.getObject("cronyxe_axe");
    public static final Item cronyxe_hoe = (Item)Item.itemRegistry.getObject("cronyxe_hoe");
    public static final Item eldarium_sword = (Item)Item.itemRegistry.getObject("eldarium_sword");
    public static final Item eldarium_pickaxe = (Item)Item.itemRegistry.getObject("eldarium_pickaxe");
    public static final Item eldarium_shovel = (Item)Item.itemRegistry.getObject("eldarium_shovel");
    public static final Item eldarium_axe = (Item)Item.itemRegistry.getObject("eldarium_axe");
    public static final Item eldarium_hoe = (Item)Item.itemRegistry.getObject("eldarium_hoe");
    public static final Item zinc_helmet = (Item)Item.itemRegistry.getObject("zinc_helmet");
    public static final Item zinc_chestplate = (Item)Item.itemRegistry.getObject("zinc_chestplate");
    public static final Item zinc_leggings = (Item)Item.itemRegistry.getObject("zinc_leggings");
    public static final Item zinc_boots = (Item)Item.itemRegistry.getObject("zinc_boots");
    public static final Item kobalt_helmet = (Item)Item.itemRegistry.getObject("kobalt_helmet");
    public static final Item kobalt_chestplate = (Item)Item.itemRegistry.getObject("kobalt_chestplate");
    public static final Item kobalt_leggings = (Item)Item.itemRegistry.getObject("kobalt_leggings");
    public static final Item kobalt_boots = (Item)Item.itemRegistry.getObject("kobalt_boots");
    public static final Item cronyxe_helmet = (Item)Item.itemRegistry.getObject("cronyxe_helmet");
    public static final Item cronyxe_chestplate = (Item)Item.itemRegistry.getObject("cronyxe_chestplate");
    public static final Item cronyxe_leggings = (Item)Item.itemRegistry.getObject("cronyxe_leggings");
