...
public abstract class EntityLivingBase extends Entity
{
    ...
    public LadderInfo getLadderInfo()
    {
        ...
        if (var4 == Blocks.ladder || var4 == Blocks.vine)
            return new LadderInfo(true, 1);
        else if (var4 == Blocks.iron_ladder)
            return new LadderInfo(true, 2);
        return new LadderInfo(false, 1);
    }
    ...
    protected float applyPotionDamageCalculations(DamageSource p_70672_1_, float p_70672_2_)
    {
        ...
        else
        {
            ...
            if (p_70672_2_ <= 0.0F || this.isPotionActive(Potion.featherFalling) && p_70672_1_ == DamageSource.fall)
            {
                return 0.0F;
            }
            else
    ...
    protected void jump()
    {
        ...
        if (this.worldObj.getBlock(x, y, z) == Blocks.slime)       // Slimeblock boost le jump
            this.motionY *= 1.75;
    ...
    public void moveEntityWithHeading(float p_70612_1_, float p_70612_2_)
    {
        ...
        else
        {
            ...
            LadderInfo ladder = this.getLadderInfo();
            if (ladder.onLadder)
            {
                float var6 = 0.15F;
                ...
                {
                    this.motionY = -0.15D*ladder.speedModifier;
                }
            ...
            ladder = this.getLadderInfo();
            if (this.isCollidedHorizontally && ladder.onLadder)
            {
                this.motionY = 0.2D*ladder.speedModifier;
            }
    ...
    public class LadderInfo {
        ...
        public LadderInfo(boolean onLadder, int speedModifier) {
