...
public class EntityList
{
    ...
    public static Map stringToClassMapping = new HashMap(); // Keyrisium - private -> public
    ...
    static
    {
        ...
        addMapping(EntityDynamite.class, "Dynamite", 23);                // Keyrisium - Register dynamite entity
        addMapping(EntityC4.class, "C4", 24);                            // Keyrisium - Register c4 entity
        addMapping(EntityTomahawk.class, "Tomahawk", 25);                // Keyrisium - Register tomahawk entity
