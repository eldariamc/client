...
public class EntityArrow extends Entity implements IProjectile
{
    ...
    public void onUpdate()
    {
        ...
        Block var16 = this.worldObj.getBlock(this.blockX, this.blockY, this.blockZ);

        if (var16.getMaterial() != Material.air)
        {
            var16.setBlockBoundsBasedOnState(this.worldObj, this.blockX, this.blockY, this.blockZ);
            AxisAlignedBB var2 = var16.getCollisionBoundingBoxFromPool(this.worldObj, this.blockX, this.blockY, this.blockZ);
        ...
        if (this.inGround)
        {
            int var18 = this.worldObj.getBlockMetadata(this.blockX, this.blockY, this.blockZ);
        ...
        else
        {
            ...
            if (var4 != null)
            {
                ...
                {
                    this.blockX = var4.blockX;
                    this.blockY = var4.blockY;
                    this.blockZ = var4.blockZ;
                    this.field_145790_g = this.worldObj.getBlock(this.blockX, this.blockY, this.blockZ);
                    ...
                    {
                        this.field_145790_g.onEntityCollidedWithBlock(this.worldObj, this.blockX, this.blockY, this.blockZ, this);
                    }
                }
            }
