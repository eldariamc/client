    ...
    private Packet func_151260_c()
    {
        ...
        else if (!(this.myEntity instanceof IAnimals) && !(this.myEntity instanceof EntityDragon))
        {
            ...
            else
            {
                ...
                {
                    return new S0EPacketSpawnObject(this.myEntity, 50, ((EntityTNTPrimed)this.myEntity).power);
                }
                ...
                {
                    return new S0EPacketSpawnObject(this.myEntity, 100);
                }
                else if (this.myEntity instanceof EntityC4)
                {
                    return new S0EPacketSpawnObject(this.myEntity, 101);
                }
                else if (this.myEntity instanceof EntityTomahawk)
                {
                    return new S0EPacketSpawnObject(this.myEntity, 102);
                }
                else
                {
