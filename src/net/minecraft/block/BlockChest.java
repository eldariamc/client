...
public class BlockChest extends BlockContainer
{
    ...
    {
        this(p_i45397_1_, true, 27);
    }

    protected BlockChest(int p_i45397_1_, boolean canBeLarge, int size)
    {
        super(Material.wood);
    ...
    {
        if (canBeLarge && p_149719_1_.getBlock(p_149719_2_, p_149719_3_, p_149719_4_ - 1) == this)
        {
            this.setBlockBounds(0.0625F, 0.0F, 0.0F, 0.9375F, 0.875F, 0.9375F);
        }
        else if (canBeLarge && p_149719_1_.getBlock(p_149719_2_, p_149719_3_, p_149719_4_ + 1) == this)
        {
            this.setBlockBounds(0.0625F, 0.0F, 0.0625F, 0.9375F, 0.875F, 1.0F);
        }
        else if (canBeLarge && p_149719_1_.getBlock(p_149719_2_ - 1, p_149719_3_, p_149719_4_) == this)
        {
        ...
        if (!p_149954_1_.isClient)
        {
            ...
            if (var5 != this && var6 != this || !canBeLarge)
            {
                if (var7 != this && var8 != this || !canBeLarge)
                {
                    ...
                    if (var5.isOpaque() && !var6.isOpaque())
                    {
                        var15 = 3;
                    }

                    if (var6.isOpaque() && !var5.isOpaque())
                    {
                        var15 = 2;
                    }

                    if (var7.isOpaque() && !var8.isOpaque())
                    {
                        var15 = 5;
                    }

                    if (var8.isOpaque() && !var7.isOpaque())
                    {
                        var15 = 4;
                    }
                }
                else
                {
                    ...
                    if ((var5.isOpaque() || var11.isOpaque()) && !var6.isOpaque() && !var13.isOpaque())
                    {
                        var15 = 3;
                    }

                    if ((var6.isOpaque() || var13.isOpaque()) && !var5.isOpaque() && !var11.isOpaque())
                    {
                        var15 = 2;
                    }
                }
            ...
            else
            {
                ...
                if ((var7.isOpaque() || var11.isOpaque()) && !var8.isOpaque() && !var13.isOpaque())
                {
                    var15 = 5;
                }

                if ((var8.isOpaque() || var13.isOpaque()) && !var7.isOpaque() && !var11.isOpaque())
                {
                    var15 = 4;
                }
            }
    ...
    {
        return new TileEntityChest(field_149956_a, size);
    }
