...
public class Material
{
    ...
    /**
     * Keyrisium - Version impistonable de rock
     */
    public static final Material brick = (new Material(MapColor.field_151665_m)).setRequiresTool().setImmovableMobility();
    ...
    public static final Material clay = new Material(MapColor.field_151667_k);
    ...
    public static final Material barrier = (new Material(MapColor.field_151660_b)).setRequiresTool().setImmovableMobility().setTranslucent();
