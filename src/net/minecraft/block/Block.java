...
public class Block
{
    ...
    public static void registerBlocks()
    {
        ...
        blockRegistry.addObject(46, "tnt", (new BlockTNT(1.0F)).setHardness(0.0F).setStepSound(soundTypeGrass).setBlockName("tnt").setBlockTextureName("tnt"));
        ...
        Block furnace = (new BlockFurnace()).setHardness(3.5F).setStepSound(soundTypePiston).setBlockName("furnace").setCreativeTab(CreativeTabs.tabDecorations).setBlockTextureName("furnace");
        blockRegistry.addObject(61, "furnace", furnace);
        blockRegistry.addObject(62, "lit_furnace", (new BlockFurnace(furnace)).setHardness(3.5F).setStepSound(soundTypePiston).setLightLevel(0.875F).setBlockName("furnace").setBlockTextureName("furnace"));
        ...
        blockRegistry.addObject(107, "fence_gate", (new BlockFenceGate()).setHardness(2.0F).setResistance(5.0F).setStepSound(soundTypeWood).setBlockName("fenceGate").setBlockTextureName("planks_oak"));
        ...
        blockRegistry.addObject(166, "barrier", new BlockBarrier().setBlockName("barrier").setCreativeTab(CreativeTabs.tabDecorations)); // Eldaria - add Barrier block
        blockRegistry.addObject(169, "sea_lantern", (new BlockSeaLantern(Material.glass)).setHardness(0.3F).setStepSound(soundTypeGlass).setLightLevel(1.0F).setBlockName("seaLantern").setBlockTextureName("sea_lantern"));
        ...
        blockRegistry.addObject(183, "spruce_fence_gate", (new BlockFenceGate()).setHardness(2.0F).setResistance(5.0F).setStepSound(soundTypeWood).setBlockName("spruceFenceGate").setBlockTextureName("planks_spruce"));
        blockRegistry.addObject(184, "birch_fence_gate", (new BlockFenceGate()).setHardness(2.0F).setResistance(5.0F).setStepSound(soundTypeWood).setBlockName("birchFenceGate").setBlockTextureName("planks_birch"));
        blockRegistry.addObject(185, "jungle_fence_gate", (new BlockFenceGate()).setHardness(2.0F).setResistance(5.0F).setStepSound(soundTypeWood).setBlockName("jungleFenceGate").setBlockTextureName("planks_jungle"));
        blockRegistry.addObject(186, "dark_oak_fence_gate", (new BlockFenceGate()).setHardness(2.0F).setResistance(5.0F).setStepSound(soundTypeWood).setBlockName("darkOakFenceGate").setBlockTextureName("planks_big_oak"));
        blockRegistry.addObject(187, "acacia_fence_gate", (new BlockFenceGate()).setHardness(2.0F).setResistance(5.0F).setStepSound(soundTypeWood).setBlockName("acaciaFenceGate").setBlockTextureName("planks_acacia"));
        blockRegistry.addObject(188, "spruce_fence", (new BlockFence("planks_spruce", Material.wood)).setHardness(2.0F).setResistance(5.0F).setStepSound(soundTypeWood).setBlockName("spruceFence"));
        blockRegistry.addObject(189, "birch_fence", (new BlockFence("planks_birch", Material.wood)).setHardness(2.0F).setResistance(5.0F).setStepSound(soundTypeWood).setBlockName("birchFence"));
        blockRegistry.addObject(190, "jungle_fence", (new BlockFence("planks_jungle", Material.wood)).setHardness(2.0F).setResistance(5.0F).setStepSound(soundTypeWood).setBlockName("jungleFence"));
        blockRegistry.addObject(191, "dark_oak_fence", (new BlockFence("planks_big_oak", Material.wood)).setHardness(2.0F).setResistance(5.0F).setStepSound(soundTypeWood).setBlockName("darkOakFence"));
        blockRegistry.addObject(192, "acacia_fence", (new BlockFence("planks_acacia", Material.wood)).setHardness(2.0F).setResistance(5.0F).setStepSound(soundTypeWood).setBlockName("acaciaFence"));
        blockRegistry.addObject(193, "spruce_door", (new BlockDoor(Material.wood)).setHardness(3.0F).setStepSound(soundTypeWood).setBlockName("doorSpruce").disableStats().setBlockTextureName("door_spruce"));
        blockRegistry.addObject(194, "birch_door", (new BlockDoor(Material.wood)).setHardness(3.0F).setStepSound(soundTypeWood).setBlockName("doorBirch").disableStats().setBlockTextureName("door_birch"));
        blockRegistry.addObject(195, "jungle_door", (new BlockDoor(Material.wood)).setHardness(3.0F).setStepSound(soundTypeWood).setBlockName("doorJungle").disableStats().setBlockTextureName("door_jungle"));
        blockRegistry.addObject(196, "acacia_door", (new BlockDoor(Material.wood)).setHardness(3.0F).setStepSound(soundTypeWood).setBlockName("doorAcacia").disableStats().setBlockTextureName("door_acacia"));
        blockRegistry.addObject(197, "dark_oak_door", (new BlockDoor(Material.wood)).setHardness(3.0F).setStepSound(soundTypeWood).setBlockName("doorDarkOak").disableStats().setBlockTextureName("door_dark_oak"));
        ...
        blockRegistry.addObject(id++, "reinforced_cobblestone", new Block(Material.brick).setHardness(2.0F).setResistance(10.0F).setStepSound(soundTypePiston).setBlockName("reinforcedCobblestone").setCreativeTab(CreativeTabs.tabBlock).setBlockTextureName("reinforced_cobblestone"));
        ...
        blockRegistry.addObject(id++, "lignite_ore", new BlockOre().setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("oreLignite").setBlockTextureName("lignite_ore"));
        blockRegistry.addObject(id++, "zinc_ore", new BlockOre().setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("oreZinc").setBlockTextureName("zinc_ore"));
        ...
        blockRegistry.addObject(id++, "cronyxe_chest", new BlockChest(5, false, 45).setHardness(2.5F).setStepSound(soundTypePiston).setBlockName("cronyxeChest"));
        blockRegistry.addObject(id++, "kobalt_chest", new BlockChest(6, false, 54).setHardness(2.5F).setStepSound(soundTypePiston).setBlockName("kobaltChest"));
        blockRegistry.addObject(id++, "zinc_block", new BlockCompressed(MapColor.field_151668_h).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setBlockName("blockZinc").setBlockTextureName("zinc_block"));
        ...
        blockRegistry.addObject(id++, "lucky_ore", new Block(Material.rock).setCreativeTab(CreativeTabs.tabBlock).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("oreLuck").setBlockTextureName("lucky_ore"));
