...
public abstract class Container
{
    ...
    public ItemStack slotClick(int p_75144_1_, int p_75144_2_, int p_75144_3_, EntityPlayer p_75144_4_)
    {
        ...
        InventoryPlayer playerInv = p_75144_4_.inventory;
        int var9;
        ItemStack var17;
        ...
        if (p_75144_3_ == 5)
        {
            ...
            else if (this.field_94536_g == 1)
            {
                ...
                if (var8 != null && func_94527_a(var8, playerInv.getItemStack(), true) && var8.isItemValid(playerInv.getItemStack()) && playerInv.getItemStack().stackSize > this.field_94537_h.size() && this.canDragIntoSlot(var8))
                {
            ...
            else if (this.field_94536_g == 2)
            {
                ...
                {
                    var17 = playerInv.getItemStack().copy();
                    var9 = playerInv.getItemStack().stackSize;
                    ...
                    while (var10.hasNext())
                    {
                        ...
                        if (var11 != null && func_94527_a(var11, playerInv.getItemStack(), true) && var11.isItemValid(playerInv.getItemStack()) && playerInv.getItemStack().stackSize >= this.field_94537_h.size() && this.canDragIntoSlot(var11))
                        {
        ...
        else
        {
            ...
            if ((p_75144_3_ == 0 || p_75144_3_ == 1) && (p_75144_2_ == 0 || p_75144_2_ == 1))
            {
                if (p_75144_1_ == -999)
                {
                    if (playerInv.getItemStack() != null && p_75144_1_ == -999)
                    {
                        if (p_75144_2_ == 0)
                        {
                            p_75144_4_.dropPlayerItemWithRandomChoice(playerInv.getItemStack(), true);
                            playerInv.setItemStack((ItemStack)null);
                        }

                        if (p_75144_2_ == 1)
                        {
                            p_75144_4_.dropPlayerItemWithRandomChoice(playerInv.getItemStack().splitStack(1), true);
                ...
                else
                {
                    ...
                    if (var16 != null)
                    {
                        ...
                        ItemStack var20 = playerInv.getItemStack();
                        ...
                        else if (var16.canTakeStack(p_75144_4_))
                        {
                            if (var20 == null)
                            {
                                ...
                                var16.onPickupFromSlot(p_75144_4_, playerInv.getItemStack());
                            }
            ...
            else if (p_75144_3_ == 2 && p_75144_2_ >= 0 && p_75144_2_ < 9)
            {
                ...
                {
                    var17 = playerInv.getStackInSlot(p_75144_2_);
                    boolean var18 = var17 == null || var16.inventory == playerInv && var16.isItemValid(var17);
                    var21 = -1;

                    if (!var18)
                    {
                        var21 = playerInv.getFirstEmptyStack();
                        var18 |= var21 > -1;
                    }
                    ...
                    if (var16.getHasStack() && var18)
                    {
                        ...
                        playerInv.setInventorySlotContents(p_75144_2_, var23.copy());

                        if ((var16.inventory != playerInv || !var16.isItemValid(var17)) && var17 != null)
                        {
                            if (var21 > -1)
                            {
                                playerInv.addItemStackToInventory(var17);
                    ...
                    {
                        playerInv.setInventorySlotContents(p_75144_2_, (ItemStack)null);
                        var16.putStack(var17);
                    }
                }
            }
            else if (p_75144_3_ == 3 && p_75144_4_.capabilities.isCreativeMode && playerInv.getItemStack() == null && p_75144_1_ >= 0)
            {
                var16 = (Slot)this.inventorySlots.get(p_75144_1_);
            ...
            else if (p_75144_3_ == 4 && playerInv.getItemStack() == null && p_75144_1_ >= 0)
            {
                var16 = (Slot)this.inventorySlots.get(p_75144_1_);
