...
import bspkrs.bspkrscore.fml.CommandBS;
...
public class ServerCommandManager extends CommandHandler implements IAdminCommand
{
    ...
    public ServerCommandManager()
    {
        ...
        this.registerCommand(new CommandArmorStatus());
        this.registerCommand(new CommandBS());
        this.registerCommand(new CommandStatusEffect());
