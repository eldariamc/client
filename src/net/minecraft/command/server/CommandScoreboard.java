...
public class CommandScoreboard extends CommandBase
{
    ...
    public void processCommand(ICommandSender p_71515_1_, String[] p_71515_2_)
    {
        if (p_71515_2_.length >= 1)
        {
            if (p_71515_2_[0].equalsIgnoreCase("objectives"))
            {
                ...
                else if (p_71515_2_[1].equalsIgnoreCase("addSmelting"))
                {
                    if (p_71515_2_.length < 4)
                    {
                        throw new WrongUsageException("commands.scoreboard.objectives.addSmelting.usage", new Object[0]);
                    }
            ...
            if (p_71515_2_[0].equalsIgnoreCase("players"))
            {
                ...
                else if (p_71515_2_[1].equalsIgnoreCase("addSmelting"))
                {
                    ...
                    {
                        throw new WrongUsageException("commands.scoreboard.players.addSmelting.usage", new Object[0]);
                    }
            ...
            if (p_71515_2_[0].equalsIgnoreCase("teams"))
            {
                ...
                else if (p_71515_2_[1].equalsIgnoreCase("addSmelting"))
                {
                    if (p_71515_2_.length < 3)
                    {
                        throw new WrongUsageException("commands.scoreboard.teams.addSmelting.usage", new Object[0]);
                    }
    ...
    protected void func_147193_c(ICommandSender p_147193_1_, String[] p_147193_2_, int p_147193_3_)
    {
        ...
        if (var7 == null)
        {
            throw new WrongUsageException("commands.scoreboard.objectives.addSmelting.wrongType", new Object[] {var5});
        }
        else if (var6.getObjective(var4) != null)
        {
            throw new CommandException("commands.scoreboard.objectives.addSmelting.alreadyExists", new Object[] {var4});
        }
        else if (var4.length() > 16)
        {
            throw new SyntaxErrorException("commands.scoreboard.objectives.addSmelting.tooLong", new Object[] {var4, Integer.valueOf(16)});
        }
        ...
        else
        {
            if (p_147193_2_.length > p_147193_3_)
            {
                ...
                if (var8.length() > 32)
                {
                    throw new SyntaxErrorException("commands.scoreboard.objectives.addSmelting.displayTooLong", new Object[] {var8, Integer.valueOf(32)});
                }
            ...
            func_152373_a(p_147193_1_, this, "commands.scoreboard.objectives.addSmelting.success", new Object[] {var4});
        }
    }
    ...
    protected void func_147185_d(ICommandSender p_147185_1_, String[] p_147185_2_, int p_147185_3_)
    {
        ...
        {
            throw new CommandException("commands.scoreboard.teams.addSmelting.alreadyExists", new Object[] {var4});
        }
        else if (var4.length() > 16)
        {
            throw new SyntaxErrorException("commands.scoreboard.teams.addSmelting.tooLong", new Object[] {var4, Integer.valueOf(16)});
        }
        else if (var4.length() == 0)
        {
            throw new WrongUsageException("commands.scoreboard.teams.addSmelting.usage", new Object[0]);
        ...
        else
        {
            if (p_147185_2_.length > p_147185_3_)
            {
                ...
                if (var6.length() > 32)
                {
                    throw new SyntaxErrorException("commands.scoreboard.teams.addSmelting.displayTooLong", new Object[] {var6, Integer.valueOf(32)});
                }
            ...
            func_152373_a(p_147185_1_, this, "commands.scoreboard.teams.addSmelting.success", new Object[] {var4});
        }
    }
    ...
    protected void func_147197_m(ICommandSender p_147197_1_, String[] p_147197_2_, int p_147197_3_)
    {
        ...
        else if (var4.equalsIgnoreCase("addSmelting"))
        {
    ...
    public List addTabCompletionOptions(ICommandSender p_71516_1_, String[] p_71516_2_)
    {
        ...
        else
        {
            if (p_71516_2_[0].equalsIgnoreCase("objectives"))
            {
                ...
                {
                    return getListOfStringsMatchingLastWord(p_71516_2_, new String[] {"list", "addSmelting", "remove", "setdisplay"});
                }

                if (p_71516_2_[1].equalsIgnoreCase("addSmelting"))
                {
            ...
            else if (p_71516_2_[0].equalsIgnoreCase("players"))
            {
                if (p_71516_2_.length == 2)
                {
                    return getListOfStringsMatchingLastWord(p_71516_2_, new String[] {"set", "addSmelting", "remove", "reset", "list"});
                }

                if (!p_71516_2_[1].equalsIgnoreCase("set") && !p_71516_2_[1].equalsIgnoreCase("addSmelting") && !p_71516_2_[1].equalsIgnoreCase("remove"))
                {
            ...
            else if (p_71516_2_[0].equalsIgnoreCase("teams"))
            {
                if (p_71516_2_.length == 2)
                {
                    return getListOfStringsMatchingLastWord(p_71516_2_, new String[] {"addSmelting", "remove", "join", "leave", "empty", "list", "option"});
                }
