...
public class S2DPacketOpenWindow extends Packet
{
    ...
    public S2DPacketOpenWindow(int p_i45185_1_, int p_i45185_2_, String p_i45185_3_, int p_i45185_4_, boolean p_i45185_5_, double furnaceSpeed)
    {
        this(p_i45185_1_, p_i45185_2_, p_i45185_3_, p_i45185_4_, p_i45185_5_);
    ...
    public void readPacketData(PacketBuffer p_148837_1_) throws IOException
    {
        ...
        if (this.field_148907_b == 2)
        {
            this.furnaceSpeed = p_148837_1_.readDouble();
        }
        else if (this.field_148907_b == 11)
        {
    ...
    public void writePacketData(PacketBuffer p_148840_1_) throws IOException
    {
        ...
        if (this.field_148907_b == 2)
        {
            p_148840_1_.writeDouble(this.furnaceSpeed);
        }
        else if (this.field_148907_b == 11)
        {
