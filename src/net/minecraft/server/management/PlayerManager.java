...
public class PlayerManager
{
    ...
    public class PlayerInstance
    {
        ...
        public void addPlayer(EntityPlayerMP par1EntityPlayerMP)
        {
            ...
            {
                PlayerManager.field_152627_a.debug("Failed to addSmelting player. {} already is in chunk {}, {}", new Object[] {par1EntityPlayerMP, Integer.valueOf(this.chunkLocation.chunkXPos), Integer.valueOf(this.chunkLocation.chunkZPos)});
            }
            else
            {
