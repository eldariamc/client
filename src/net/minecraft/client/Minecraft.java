...
public class Minecraft implements IPlayerUsage
{
    ...
    public Minecraft(Session p_i1103_1_, int p_i1103_2_, int p_i1103_3_, boolean p_i1103_4_, boolean p_i1103_5_, File p_i1103_6_, File p_i1103_7_, File p_i1103_8_, Proxy p_i1103_9_, String p_i1103_10_, Multimap p_i1103_11_, String p_i1103_12_)
    {
        ...
        logger.info("(Session ID is " + (isDemo() ? p_i1103_1_.getSessionID() : "<censored>") + ")");
    ...
    private void startGame() throws LWJGLException
    {
        ...
        Display.setTitle("Eldaria (MC 1.7.10) - " + session.getUsername());            // Keyrisium - Custom window Title here
    ...
    public void displayGuiScreen(GuiScreen p_147108_1_)
    {
        ...
        // Keyrisium - fire openGui event
        McpHandler.fireGuiOpen(this.currentScreen);
    }
    ...
    private void runGameLoop()
    {
        ...
        {
            McpHandler.fireRenderTick(Tickable.Phase.START);
            this.mcProfiler.endStartSection("gameRenderer");
            this.entityRenderer.updateCameraAndRender(this.timer.renderPartialTicks);
            this.mcProfiler.endSection();
            McpHandler.fireRenderTick(Tickable.Phase.END);
        }
    ...
    public void runTick()
    {
        ...
        // Keyrisium - fire START tick
        McpHandler.fireClientTick(Tickable.Phase.START);
        ...
        // Keyrisium - fire END tick
        McpHandler.fireClientTick(Tickable.Phase.END);
    ...
    public void loadWorld(@Nullable WorldClient p_71353_1_, String p_71353_2_)
    {
        ...
        if (p_71353_1_ != null)
        {
            ...
            if (this.thePlayer == null || this.thePlayer.sendQueue == null) // Keyrisium - fix for BSMainMenu
            {
