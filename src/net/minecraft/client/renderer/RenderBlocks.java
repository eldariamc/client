...
public class RenderBlocks
{
    ...
    public void renderBlockAsItem(Block block, int p_147800_2_, float p_147800_3_)
    {
        Tessellator var4 = Tessellator.instance;
        boolean var5 = block == Blocks.grass;

        if (block == Blocks.dispenser || block == Blocks.dropper || block == Blocks.furnace || block == Blocks.obsidian_furnace)
        {
            p_147800_2_ = 3;
        }
        ...
        {
            var6 = block.getRenderColor(p_147800_2_);
        ...
        if (var6 != 0 && var6 != 31 && var6 != 39 && var6 != 16 && var6 != 26)
        {
            if (var6 == 1)
            {
                ...
                IIcon var171 = this.getBlockIconFromSideAndMetadata(block, 0, p_147800_2_);
            ...
            else if (var6 == 19)
            {
                ...
                this.renderBlockStemSmall(block, p_147800_2_, this.renderMaxY, -0.5D, -0.5D, -0.5D);
                var4.draw();
            }
            else if (var6 == 23)
            {
            ...
            else if (var6 == 22)
            {
                ...
                GL11.glTranslatef(-0.5F, -0.5F, -0.5F);
                TileEntityRendererChestHelper.instance.func_147715_a(block, p_147800_2_, p_147800_3_);
            ...
            else if (var6 == 6)
            {
                var4.startDrawingQuads();
                var4.setNormal(0.0F, -1.0F, 0.0F);
                this.renderBlockCropsImpl(block, p_147800_2_, -0.5D, -0.5D, -0.5D);
                var4.draw();
            }
            else if (var6 == 2)
            {
            ...
            else if (var6 == 32)
            {
                for (var14 = 0; var14 < 2; ++var14)
                {
                    ...
                    var4.startDrawingQuads();
                    var4.setNormal(0.0F, -1.0F, 0.0F);
                    this.renderFaceYNeg(block, 0.0D, 0.0D, 0.0D, this.getBlockIconFromSideAndMetadata(block, 0, p_147800_2_));
                    var4.draw();
                    var4.startDrawingQuads();
                    var4.setNormal(0.0F, 1.0F, 0.0F);
                    this.renderFaceYPos(block, 0.0D, 0.0D, 0.0D, this.getBlockIconFromSideAndMetadata(block, 1, p_147800_2_));
                    var4.draw();
                    var4.startDrawingQuads();
                    var4.setNormal(0.0F, 0.0F, -1.0F);
                    this.renderFaceZNeg(block, 0.0D, 0.0D, 0.0D, this.getBlockIconFromSideAndMetadata(block, 2, p_147800_2_));
                    var4.draw();
                    var4.startDrawingQuads();
                    var4.setNormal(0.0F, 0.0F, 1.0F);
                    this.renderFaceZPos(block, 0.0D, 0.0D, 0.0D, this.getBlockIconFromSideAndMetadata(block, 3, p_147800_2_));
                    var4.draw();
                    var4.startDrawingQuads();
                    var4.setNormal(-1.0F, 0.0F, 0.0F);
                    this.renderFaceXNeg(block, 0.0D, 0.0D, 0.0D, this.getBlockIconFromSideAndMetadata(block, 4, p_147800_2_));
                    var4.draw();
                    var4.startDrawingQuads();
                    var4.setNormal(1.0F, 0.0F, 0.0F);
                    this.renderFaceXPos(block, 0.0D, 0.0D, 0.0D, this.getBlockIconFromSideAndMetadata(block, 5, p_147800_2_));
                    var4.draw();
                    GL11.glTranslatef(0.5F, 0.5F, 0.5F);
                }
            ...
            {
                GL11.glTranslatef(-0.5F, -0.5F, -0.5F);
                this.renderBlockAnvilOrient((BlockAnvil)block, 0, 0, 0, p_147800_2_ << 2, true);
                GL11.glTranslatef(0.5F, 0.5F, 0.5F);
            }
            else if (var6 == 34)
            {
            ...
            {
                Reflector.callVoid(Reflector.ModLoader_renderInvBlock, new Object[] {this, block, Integer.valueOf(p_147800_2_), Integer.valueOf(var6)});
            }
            else if (Reflector.FMLRenderAccessLibrary.exists())
            {
                Reflector.callVoid(Reflector.FMLRenderAccessLibrary_renderInventoryBlock, new Object[] {this, block, Integer.valueOf(p_147800_2_), Integer.valueOf(var6)});
            }
        }
        else
        {
            ...
            {
                var14 = block.getRenderColor(p_147800_2_);
