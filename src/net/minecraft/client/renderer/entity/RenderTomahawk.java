...
public class RenderTomahawk extends Render {
	private static final ResourceLocation tomahawkTextures = new ResourceLocation("textures/entity/c4.png");
	 ...
	 */
	public void doRender(EntityTomahawk entity, double x, double y, double z, float yaw, float pitch)
	{
		GL11.glPushMatrix();
	...
	{
		return this.getEntityTexture((EntityTomahawk) entity);
	}
	...
	{
		this.doRender((EntityTomahawk) entity, x, y, z, yaw, pitch);
	}
}
