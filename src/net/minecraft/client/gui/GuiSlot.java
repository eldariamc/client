...
public abstract class GuiSlot
{
    ...
    public int func_148124_c(int p_148124_1_, int p_148124_2_)
    {
        ...
        int var5 = p_148124_2_ - this.top - this.field_148160_j + (int)this.field_148169_q - 4;
    ...
    {
        return this.func_148138_e() - (this.bottom - this.top - 4);
    }
    ...
    public void func_148128_a(int p_148128_1_, int p_148128_2_, float p_148128_3_)
    {
            ...
            if (Mouse.isButtonDown(0) && this.func_148125_i())
            {
                if (this.field_148157_o == -1.0F)
                {
                    ...
                    if (p_148128_2_ >= this.top && p_148128_2_ <= this.bottom)
                    {
                        ...
                        var10 = p_148128_2_ - this.top - this.field_148160_j + (int)this.field_148169_q - 4;
                        ...
                        {
                            this.func_148132_a(p_148128_1_ - var8, p_148128_2_ - this.top + (int)this.field_148169_q - 4);
                            var15 = false;
                        }
                        ...
                        if (p_148128_1_ >= var5 && p_148128_1_ <= var6)
                        {
                            ...
                            var13 = (int)((float)((this.bottom - this.top) * (this.bottom - this.top)) / (float)this.func_148138_e());
        ...
        var16.addVertexWithUV((double)this.left, (double)this.bottom, 0.0D, (double)((float)this.left / var17), (double)((float)(this.bottom + (int)this.field_148169_q) / var17));
        var16.addVertexWithUV((double)this.right, (double)this.bottom, 0.0D, (double)((float)this.right / var17), (double)((float)(this.bottom + (int)this.field_148169_q) / var17));
        var16.addVertexWithUV((double)this.right, (double)this.top, 0.0D, (double)((float)this.right / var17), (double)((float)(this.top + (int)this.field_148169_q) / var17));
        var16.addVertexWithUV((double)this.left, (double)this.top, 0.0D, (double)((float)this.left / var17), (double)((float)(this.top + (int)this.field_148169_q) / var17));
        var16.draw();
        ...
        this.func_148136_c(this.bottom, this.field_148158_l, 255, 255);
        ...
        if (var19 > 0)
        {
            var13 = (this.bottom - this.top) * (this.bottom - this.top) / this.func_148138_e();
