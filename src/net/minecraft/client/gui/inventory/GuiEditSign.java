...
public class GuiEditSign extends GuiScreen
{
    ...
    public void onGuiClosed()
    {
        ...
        if (var1 != null)
        {
            var1.addToSendQueue(new C12PacketUpdateSign(this.field_146848_f.posX, this.field_146848_f.posY, this.field_146848_f.posZ, this.field_146848_f.field_145915_a));
        }
