...
public class GuiChest extends GuiContainer
{
    ...
    public GuiChest(IInventory p_i1083_1_, IInventory p_i1083_2_)
    {
        ...
        this.defaultY = var4 + this.field_147018_x * 18;
    }
    ...
    protected void func_146979_b(int p_146979_1_, int p_146979_2_)
    {
        ...
        this.fontRendererObj.drawString(this.field_147016_v.isInventoryNameLocalized() ? this.field_147016_v.getInventoryName() : I18n.format(this.field_147016_v.getInventoryName(), new Object[0]), 8, this.defaultY - 96 + 2, 4210752);
    }
    ...
    protected void func_146976_a(float p_146976_1_, int p_146976_2_, int p_146976_3_)
    {
        ...
        this.drawTexturedModalRect(var4, var5, 0, 0, this.defaultX, this.field_147018_x * 18 + 17);
        this.drawTexturedModalRect(var4, var5 + this.field_147018_x * 18 + 17, 0, 126, this.defaultX, 96);
    }
}
