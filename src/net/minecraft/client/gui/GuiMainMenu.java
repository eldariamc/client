...
import bspkrs.bspkrscore.fml.BSMainMenuRenderTicker;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    private static final ResourceLocation backgroundTextures = new ResourceLocation("textures/gui/title/background.png");
    ...
    private final ServerData server = new ServerData("Eldaria", SERVER_IP);
    ...
    public void updateScreen()
    {
        ...
        // Eldaria - display server slots
        /*if (pinging && server.populationInfo != null && !server.populationInfo.isEmpty()) {
            multiplayerButton.displayString = I18n.format("menu.multiplayer") + " " + server.populationInfo;
            pinging = false;
        }*/
    }
    ...
    public void initGui()
    {
        ...
        {*/
        this.addSingleplayerMultiplayerButtons(var3 + 24, 24);
        //}

        this.buttonList.add(new GuiButton(0, (this.width/*-100*/) / 2 - 100, var3 + 72 + 12, 98, 20, I18n.format("menu.options", new Object[0])));
        this.buttonList.add(new GuiButton(4, (this.width/*-100*/) / 2 + 2, var3 + 72 + 12, 98, 20, I18n.format("menu.quit", new Object[0])));
        //this.buttonList.add(new GuiButtonLanguage(5, (this.width/*-100*/) / 2 - 124, var3 + 72 + 12));
        ...
        mc.thePlayer.height = 1.82F;
        BSMainMenuRenderTicker.setRandomMobItem(mc.thePlayer);
    }
    ...
    {
        this.buttonList.add(new GuiButton(2, (this.width/*-100*/) / 2 - 100, p_73969_1_, /*I18n.format("menu.multiplayer")*/ "§8§l\u226b §6§nSe connecter au serveur§r§8§l \u226a"));
        this.buttonList.add(new GuiButton(1, (this.width/*-100*/) / 2 - 100, p_73969_1_ + p_73969_2_ * 1, I18n.format("menu.singleplayer", new Object[0])));
    ...
    protected void actionPerformed(GuiButton p_146284_1_)
    {
        ...
        if (p_146284_1_.id == 2)
        {
            if (this.mc.isDemo()) {
                ...
                server.func_152584_a(ServerData.ServerResourceMode.ENABLED);
    ...
    private void drawRandMob() {
        ...
        float scale = EntityUtils.getEntityScale(mc.thePlayer, targetHeight, 1.8F);
        GuiInventory.func_147046_a(this.width - 75, this.height / 2, 50, (float)(distanceToSide - mouseX), (float)(sr.getScaledHeight() / 2) + mc.thePlayer.height * scale - mc.thePlayer.height * scale * (mc.thePlayer.getEyeHeight() / mc.thePlayer.height) - (float)mouseY, mc.thePlayer);
        System.out.println("Entity " + mc.thePlayer.getCommandSenderName() + " has been drawn");
    }
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_)
    {
        ...
        Tessellator var4 = Tessellator.instance;
        short var5 = 274;
        int var6 = (this.width/*-100*/) / 2 - var5 / 2;
        byte var7 = 30;
        this.drawGradientRect(0, 0, this.width, this.height, -2130706433, 16777215);
        this.drawGradientRect(0, 0, this.width, this.height, 0, Integer.MIN_VALUE);
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);

        // Eldaria - draw background
        ...
        GL11.glPushMatrix();
        GL11.glTranslatef((float)((this.width/*-100*/) / 2 + 90), 70.0F, 0.0F);
        ...
        String motd = "Joueurs connectés : " + (server.populationInfo == null ? "..." : server.populationInfo);
        ...
        String var10 = "Développé par Dabsunter"; // copyrights
