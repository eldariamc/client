...
public class GuiMerchant extends GuiContainer
{
    ...
    {
        this.fontRendererObj.drawString(this.field_147040_A, this.defaultX / 2 - this.fontRendererObj.getStringWidth(this.field_147040_A) / 2, 6, 4210752);
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_)
    {
        ...
        {
            int var5 = (this.width - this.defaultX) / 2;
            int var6 = (this.height - this.defaultY) / 2;
            int var7 = this.field_147041_z;
