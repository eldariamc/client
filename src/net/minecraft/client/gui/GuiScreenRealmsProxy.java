...
public class GuiScreenRealmsProxy extends GuiScreen
{
     ...
     */
    public void drawTexturedModalRect(int p_73729_1_, int p_73729_2_, int u, int v, int width, int height)
    {
        this.field_154330_a.blit(p_73729_1_, p_73729_2_, u, v, width, height);
        super.drawTexturedModalRect(p_73729_1_, p_73729_2_, u, v, width, height);
    }
