...
public class GuiTextField extends Gui
{
    ...
    {
        boolean var4 = p_146192_1_ >= this.xPosition && p_146192_1_ < this.xPosition + this.field_146218_h && p_146192_2_ >= this.yPosition && p_146192_2_ < this.yPosition + this.field_146219_i;
    ...
    public void drawTextBox()
    {
        if (this.func_146176_q())
        {
            ...
            {
                drawRect(this.xPosition - 1, this.yPosition - 1, this.xPosition + this.field_146218_h + 1, this.yPosition + this.field_146219_i + 1, -6250336);
                drawRect(this.xPosition, this.yPosition, this.xPosition + this.field_146218_h, this.yPosition + this.field_146219_i, -16777216);
            }
            ...
            int var7 = this.field_146215_m ? this.xPosition + 4 : this.xPosition;
            int var8 = this.field_146215_m ? this.yPosition + (this.field_146219_i - 8) / 2 : this.yPosition;
            int var9 = var7;
    ...
    private void func_146188_c(int p_146188_1_, int p_146188_2_, int p_146188_3_, int p_146188_4_)
    {
        ...
        if (p_146188_3_ > this.xPosition + this.field_146218_h)
        {
            p_146188_3_ = this.xPosition + this.field_146218_h;
        }

        if (p_146188_1_ > this.xPosition + this.field_146218_h)
        {
            p_146188_1_ = this.xPosition + this.field_146218_h;
        }
