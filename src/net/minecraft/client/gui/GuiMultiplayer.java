...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void func_146794_g()
    {
        ...
        this.buttonList.add(new GuiButton(3, this.width / 2 + 4 + 50, this.height - 52, 100, 20, I18n.format("selectServer.addSmelting", new Object[0])));
    ...
    {
        GuiScreen screen = this.field_146798_g;
        if (this.mc.isDemo())
            screen = new GuiMultiplayer(screen);
    ...
    public void confirmClicked(boolean p_73878_1_, int p_73878_2_)
    {
        ...
        else if (this.field_146813_x)
        {
            ...
            if (p_73878_1_)
            {
                this.connect(this.field_146811_z);
            }
            else
            {
                this.mc.displayGuiScreen(this);
    ...
    public void func_146796_h()
    {
        ...
        {
            this.connect(((ServerListEntryNormal)var1).func_148296_a());
        }
        else if (var1 instanceof ServerListEntryLanDetected)
        {
            ...
            this.connect(new ServerData(var2.getServerMotd(), var2.getServerIpPort(), true));
        }
    }

    public void connect(ServerData p_146791_1_)
    {
