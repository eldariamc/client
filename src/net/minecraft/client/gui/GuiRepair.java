...
public class GuiRepair extends GuiContainer implements ICrafting
{
    ...
    public void initGui()
    {
        ...
        int var1 = (this.width - this.defaultX) / 2;
        int var2 = (this.height - this.defaultY) / 2;
    ...
    protected void func_146979_b(int p_146979_1_, int p_146979_2_)
    {
        ...
        if (this.field_147092_v.maximumCost > 0)
        {
            ...
            if (var4)
            {
                ...
                int var7 = this.defaultX - 8 - this.fontRendererObj.getStringWidth(var5);
                byte var8 = 67;

                if (this.fontRendererObj.getUnicodeFlag())
                {
                    drawRect(var7 - 3, var8 - 2, this.defaultX - 7, var8 + 10, -16777216);
                    drawRect(var7 - 2, var8 - 1, this.defaultX - 8, var8 + 9, -12895429);
                }
                else
                {
    ...
    protected void func_146976_a(float p_146976_1_, int p_146976_2_, int p_146976_3_)
    {
        ...
        this.drawTexturedModalRect(var4 + 59, var5 + 20, 0, this.defaultY + (this.field_147092_v.getSlot(0).getHasStack() ? 0 : 16), 110, 16);
        ...
        {
            this.drawTexturedModalRect(var4 + 99, var5 + 45, this.defaultX, 0, 28, 21);
        }
    }
