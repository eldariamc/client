...
{
    public boolean BetterSprintingClassCheck;
    ...
    public void onLivingUpdate()
    {
        ...
        else
        {
            ...
            if(GuiSprint.disableModFunctionality) {
                ...
                /*if(this.D && !var3 && this.c.b >= var2 && !this.ao() && var4 && !this.by() && !this.a((rv)rv.q)) {
                    if(this.e <= 0 && !GuiSprint.keyBindSprint.d()) {
                        this.e = 7;
                    } else {
                        this.c(true);
                    }
                ...
                if(!this.ao() && this.c.b >= var2 && var4 && !this.by() && !this.a((rv)rv.q) && GuiSprint.keyBindSprint.d()) {
                    this.c(true);
                }

                if(this.ao() && (this.c.b < var2 || this.E || !var4)) {
                    this.c(false);
                }*/
            } else {
                ...
                if((doubletap && !this.isSprinting() || !doubletap) && this.onGround && var4 && !this.isUsingItem() && !this.isPotionActive(Potion.blindness)) {
            ...
            if(GuiSprint.keyBindSprintMenu.getIsKeyPressed()) {
                this.mc.displayGuiScreen(new GuiSprint(null));
            }
    ...
    {
        this.mc.displayGuiScreen(new GuiWaterPipe(this.inventory, waterPipe));
    }
