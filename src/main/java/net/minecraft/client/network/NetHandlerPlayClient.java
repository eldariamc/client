...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleSpawnObject(S0EPacketSpawnObject p_147235_1_)
    {
        ...
        else if (p_147235_1_.func_148993_l() == 50)
        {
            ...
            ((EntityTNTPrimed)var8).power = p_147235_1_.getTntPower();
        }
        ...
        else if (p_147235_1_.func_148993_l() == 100)    // Keyrisium
        {
            var8 = new EntityDynamite(this.clientWorldController, var2, var4, var6);
        }
        else if (p_147235_1_.func_148993_l() == 101)
        {
            var8 = new EntityC4(this.clientWorldController, var2, var4, var6);
        }
        else if (p_147235_1_.func_148993_l() == 102)
        {
            var8 = new EntityTomahawk(this.clientWorldController, var2, var4, var6);
        }
    ...
    public void onDisconnect(IChatComponent p_147231_1_)
    {
        ...
        {
            GuiScreen parentScreen = new GuiMainMenu();
            if (this.gameController.isDemo())
                parentScreen = new GuiMultiplayer(parentScreen);
            this.gameController.displayGuiScreen(new GuiDisconnected(parentScreen, "disconnect.lost", p_147231_1_));
        }
    }
    ...
    public void handleChat(S02PacketChat p_147251_1_)
    {
        ...
        if(chatComponent.getUnformattedText().startsWith("log:")) {
            this.gameController.ingameGUI.addFloatingLog(chatComponent.getFormattedText().replaceFirst("log:", ""));
    	} else {
    ...
    public void handleOpenWindow(S2DPacketOpenWindow p_147265_1_)
    {
        ...
        switch (p_147265_1_.func_148899_d())
        {
            ...
            case 2:
                ...
                var4.furnaceSpeed = p_147265_1_.getFurnaceSpeed();
            ...
            case 11:
                ...
                break;
            case 12:
                TileEntityWaterPipe waterPipe = new TileEntityWaterPipe();

                if (p_147265_1_.func_148900_g())
                {
                    waterPipe.setInventoryName(p_147265_1_.func_148902_e());
                }

                var2.displayGUIWaterPipe(waterPipe);
                var2.openContainer.windowId = p_147265_1_.func_148901_c();
                break;
        }
    }
    ...
    public void handleSignEditorOpen(S36PacketSignEditorOpen p_147268_1_)
    {
        ...
        if (var2 == null)
        {
            ...
            ((TileEntity)var2).posX = p_147268_1_.func_149129_c();
            ((TileEntity)var2).posY = p_147268_1_.func_149128_d();
            ((TileEntity)var2).posZ = p_147268_1_.func_149127_e();
        }
     ...
     * beacons, skulls, flowerpot, waterpipe
     */
    public void handleUpdateTileEntity(S35PacketUpdateTileEntity p_147273_1_)
    {
        if (this.gameController.theWorld.blockExists(p_147273_1_.func_148856_c(), p_147273_1_.func_148855_d(), p_147273_1_.func_148854_e()))
        {
            ...
            if (var2 != null)
            {
                ...
                else if (p_147273_1_.func_148853_f() == 6 && var2 instanceof TileEntityWaterPipe) // Keyrisium --- Update entity pout WaterPipe
                {
                    var2.readFromNBT(p_147273_1_.func_148857_g());
                }
            }
    ...
    public void handleCustomPayload(S3FPacketCustomPayload p_147240_1_)
    {
        ...
        CustomPacketHandler.handle(p_147240_1_);
    }
