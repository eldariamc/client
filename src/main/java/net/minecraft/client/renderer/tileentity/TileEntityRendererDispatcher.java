...
public class TileEntityRendererDispatcher
{
    ...
    private TileEntityRendererDispatcher()
    {
        ...
        this.mapSpecialRenderers.put(TileEntityWaterPipe.class, new TileEntityWaterPipeRenderer()); // Eldaria - register WaterPipe renderer
    ...
    public void func_147544_a(TileEntity p_147544_1_, float p_147544_2_)
    {
        ...
        {
            int var3 = this.field_147550_f.getLightBrightnessForSkyBlocks(p_147544_1_.posX, p_147544_1_.posY, p_147544_1_.posZ, 0);
            int var4 = var3 % 65536;
            int var5 = var3 / 65536;
            OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit, (float)var4 / 1.0F, (float)var5 / 1.0F);
            GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
            this.func_147549_a(p_147544_1_, (double)p_147544_1_.posX - staticPlayerX, (double)p_147544_1_.posY - staticPlayerY, (double)p_147544_1_.posZ - staticPlayerZ, p_147544_2_);
        }
    }
