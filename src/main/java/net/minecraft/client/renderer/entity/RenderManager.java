...
public class RenderManager
{
    ...
    private RenderManager()
    {
        ...
        this.entityRenderMap.put(EntityDynamite.class, new RenderDynamite());            // Keyrisium - add dynamite renderer
        this.entityRenderMap.put(EntityC4.class, new RenderC4());                        // Keyrisium - add c4 renderer
        this.entityRenderMap.put(EntityTomahawk.class, new RenderTomahawk());            // Keyrisium - add tomahawk renderer
