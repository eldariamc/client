...
public class RenderBiped extends RenderLiving
{
    ...
    private static final String[] bipedArmorFilenamePrefix =
            new String[] {"leather", "chainmail", "iron", "diamond", "gold", "zinc","cronyxe", "kobalt",  "eldarium"};
    ...
    {
        String var3 = String.format("textures/models/armor/%s_layer_%d%s.png", bipedArmorFilenamePrefix[p_110858_0_.renderIndex], p_110858_1_ == 2 ? 2 : 1, p_110858_2_ == null ? "" : String.format("_%s", p_110858_2_));
    ...
    protected void renderEquippedItems(EntityLiving p_77029_1_, float p_77029_2_)
    {
        ...
        if (var3 != null && var3.getItem() != null)
        {
            ...
            else if (var5 == Items.bow_cronyxe)
            {
                var6 = 0.625F;
                GL11.glTranslatef(0.0F, 0.125F, 0.3125F);
                GL11.glRotatef(-20.0F, 0.0F, 1.0F, 0.0F);
            ...
            else if (var5 == Items.bow_eldarium)
            {
                var6 = 0.625F;
                GL11.glTranslatef(0.0F, 0.125F, 0.3125F);
                GL11.glRotatef(-20.0F, 0.0F, 1.0F, 0.0F);
