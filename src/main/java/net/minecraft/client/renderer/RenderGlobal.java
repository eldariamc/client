...
public class RenderGlobal implements IWorldAccess
{
    ...
    public void renderEntities(EntityLivingBase p_147589_1_, ICamera p_147589_2_, float p_147589_3_)
    {
        ...
        else
        {
            ...
            List<Entity> outlineList = Lists.<Entity>newArrayList();   // Keyrisium - OutLine
            ...
            for (var25 = 0; var25 < var24.size(); ++var25)
            {
                ...
                if (!hasEntityShouldRenderInPass || Reflector.callBoolean(var19, Reflector.ForgeEntity_shouldRenderInPass, new Object[] {Integer.valueOf(pass)}))
                {
                    ...
                    if (te && (var19 != this.mc.renderViewEntity || this.mc.gameSettings.thirdPersonView != 0 || this.mc.renderViewEntity.isPlayerSleeping()) && this.theWorld.blockExists(MathHelper.floor_double(var19.posX), 0, MathHelper.floor_double(var19.posZ)))
                    {
                        ...
                        if (this.isOutlineActive(var19, this.mc.renderViewEntity, p_147589_2_))
                        {
                            outlineList.add(var19);
                        }
                    }
                }
            }

            if (this.isRenderEntityOutlines() && (!outlineList.isEmpty() || this.entityOutlinesRendered))
            {
                this.theWorld.theProfiler.endStartSection("entityOutlines");
                this.entityOutlineFramebuffer.framebufferClear();
                this.entityOutlinesRendered = !outlineList.isEmpty();
                ...
                /*if (!outlineList.isEmpty())
                {
                    ...
                    for (int j = 0; j < ((List)outlineList).size(); ++j)
                    {
                        this.renderManager.renderEntityStatic((Entity)outlineList.get(j), partialTicks, false);
                    }
            ...
            for (var25 = 0; var25 < this.tileEntities.size(); ++var25)
            {
                ...
                if (!hasTileEntityShouldRenderInPass || Reflector.callBoolean(var27, Reflector.ForgeTileEntity_shouldRenderInPass, new Object[] {Integer.valueOf(pass)}))
                {
                    ...
                    if (var29 == AABB_INFINITE || p_147589_2_.isBoundingBoxInFrustum(var29))
                    {
                        ...
                        {
                            Block var31 = this.theWorld.getBlock(var27.posX, var27.posY, var27.posZ);
    ...
    public AxisAlignedBB getTileEntityBoundingBox(TileEntity te)
    {
        ...
        else
        {
            ...
            {
                return AxisAlignedBB.getBoundingBox((double)te.posX, (double)te.posY, (double)te.posZ, (double)(te.posX + 1), (double)(te.posY + 1), (double)(te.posZ + 1));
            }
            else if (blockType != Blocks.chest && blockType != Blocks.trapped_chest && blockType != Blocks.mystery_box && blockType != Blocks.magic_chest)
            {
                ...
                {
                    blockAabb = blockType.getCollisionBoundingBoxFromPool(te.getWorldObj(), te.posX, te.posY, te.posZ);
            ...
            {
                return AxisAlignedBB.getBoundingBox((double)(te.posX - 1), (double)te.posY, (double)(te.posZ - 1), (double)(te.posX + 2), (double)(te.posY + 2), (double)(te.posZ + 2));
            }
        }
    }
    ...
    public int getCountEntitiesTotal() {
        return countEntitiesTotal;
    }

    // --- Keyrisium : Add OutLine ---
    ...
    public void renderEntityOutlineFramebuffer()
    {
        if (this.isRenderEntityOutlines())
        {
            ...
            this.entityOutlineFramebuffer.framebufferRender(this.mc.displayWidth, this.mc.displayHeight, false);
