...
public class S0EPacketSpawnObject extends Packet
{
    ...
    public S0EPacketSpawnObject(Entity entity, int type, float tntPower) {
        this(entity, type);
    ...
    public void readPacketData(PacketBuffer p_148837_1_) throws IOException
    {
        ...
        if (this.field_149019_j == 50)
            this.tntPower = p_148837_1_.readFloat();
    }
    ...
    public void writePacketData(PacketBuffer p_148840_1_) throws IOException
    {
        ...
        if (this.field_149019_j == 50)
            p_148840_1_.writeFloat(this.tntPower);
    }
