...
import static net.minecraft.item.ItemArmor.ArmorMaterial.CRONYXE;
...
public class Item
{
    ...
    public static void registerItems()
    {
        ...
        itemRegistry.addObject(288, "feather", (new Item()).setUnlocalizedName("feather").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("feather").setPotionEffect(PotionHelper.featherEffect));
        ...
        itemRegistry.addObject(324, "wooden_door", (new ItemDoor(Blocks.wooden_door)).setUnlocalizedName("doorWood").setTextureName("door_wood"));
        ...
        itemRegistry.addObject(330, "iron_door", (new ItemDoor(Blocks.iron_door)).setUnlocalizedName("doorIron").setTextureName("door_iron"));
        ...
        itemRegistry.addObject(341, "slime_ball", (new Item()).setUnlocalizedName("slimeball").setCreativeTab(CreativeTabs.tabMisc).setTextureName("slimeball").setPotionEffect(PotionHelper.rabbitFootEffect));
        ...
        itemRegistry.addObject(427, "spruce_door", (new ItemDoor(Blocks.spruce_door)).setUnlocalizedName("doorSpruce").setTextureName("door_spruce"));
        itemRegistry.addObject(428, "birch_door", (new ItemDoor(Blocks.birch_door)).setUnlocalizedName("doorBirch").setTextureName("door_birch"));
        itemRegistry.addObject(429, "jungle_door", (new ItemDoor(Blocks.jungle_door)).setUnlocalizedName("doorJungle").setTextureName("door_jungle"));
        itemRegistry.addObject(430, "acacia_door", (new ItemDoor(Blocks.acacia_door)).setUnlocalizedName("doorAcacia").setTextureName("door_acacia"));
        itemRegistry.addObject(431, "dark_oak_door", (new ItemDoor(Blocks.dark_oak_door)).setUnlocalizedName("doorDarkOak").setTextureName("door_dark_oak"));
        ...
        id = registerArmor(id, ItemArmor.ArmorMaterial.CRONYXE);
		id = registerTools(id, ToolMaterial.KOBALT);
        ...
        itemRegistry.addObject(id++, "peppers", new ItemSeedFood(4, 0.6F, Blocks.peppers, Blocks.farmland).setAlwaysEdible().setPotionEffect(12, 360, 0, 1.0F).setPotionEffect(PotionHelper.hasteEffect).setUnlocalizedName("peppers").setTextureName("peppers"));
        ...
        HashSet<Block> exceptions = Sets.newHashSet(Blocks.air, Blocks.brewing_stand, Blocks.bed, Blocks.nether_wart,
                ...
                Blocks.lit_redstone_lamp, Blocks.melon_stem, Blocks.unlit_redstone_torch, Blocks.unpowered_comparator,
                Blocks.redstone_wire, Blocks.wall_sign, Blocks.unpowered_repeater, Blocks.iron_door, Blocks.wooden_door,
        ...
        while (var2.hasNext())
        {
            ...
            Block block = (Block)Block.blockRegistry.getObject(var3);
            Object item;
            ...
            {
                item = (new ItemCloth(Blocks.stained_hardened_clay)).setUnlocalizedName("clayHardenedStained");
            }
            ...
            {
                item = (new ItemCloth(Blocks.stained_glass_pane)).setUnlocalizedName("stainedGlassPane");
            }
            ...
            {
                item = (new ItemMultiTexture(Blocks.dirt, Blocks.dirt, BlockDirt.field_150009_a)).setUnlocalizedName("dirt");
            }
            else if (block == Blocks.sand)
            {
                item = (new ItemMultiTexture(Blocks.sand, Blocks.sand, BlockSand.field_149838_a)).setUnlocalizedName("sand");
            }
            else if (block == Blocks.log)
            {
                item = (new ItemMultiTexture(Blocks.log, Blocks.log, BlockOldLog.field_150168_M)).setUnlocalizedName("log");
            }
            else if (block == Blocks.log2)
            {
                item = (new ItemMultiTexture(Blocks.log2, Blocks.log2, BlockNewLog.field_150169_M)).setUnlocalizedName("log");
            }
            else if (block == Blocks.planks)
            {
                item = (new ItemMultiTexture(Blocks.planks, Blocks.planks, BlockWood.field_150096_a)).setUnlocalizedName("wood");
            }
            else if (block == Blocks.monster_egg)
            {
                item = (new ItemMultiTexture(Blocks.monster_egg, Blocks.monster_egg, BlockSilverfish.field_150198_a)).setUnlocalizedName("monsterStoneEgg");
            }
            else if (block == Blocks.stonebrick)
            {
                item = (new ItemMultiTexture(Blocks.stonebrick, Blocks.stonebrick, BlockStoneBrick.field_150142_a)).setUnlocalizedName("stonebricksmooth");
            }
            else if (block == Blocks.sandstone)
            {
                item = (new ItemMultiTexture(Blocks.sandstone, Blocks.sandstone, BlockSandStone.field_150157_a)).setUnlocalizedName("sandStone");
            }
            else if (block == Blocks.quartz_block)
            {
                item = (new ItemMultiTexture(Blocks.quartz_block, Blocks.quartz_block, BlockQuartz.field_150191_a)).setUnlocalizedName("quartzBlock");
            }
            else if (block == Blocks.stone)
            {
                item = new ItemMultiTexture(Blocks.stone, Blocks.stone, BlockStone.NAMES).setUnlocalizedName("stone"); // Keyrisium - Add stone types (granite...)
            }
            else if (block == Blocks.stone_slab)
            {
                item = (new ItemSlab(Blocks.stone_slab, Blocks.stone_slab, Blocks.double_stone_slab, false)).setUnlocalizedName("stoneSlab");
            }
            else if (block == Blocks.double_stone_slab)
            {
                item = (new ItemSlab(Blocks.double_stone_slab, Blocks.stone_slab, Blocks.double_stone_slab, true)).setUnlocalizedName("stoneSlab");
            }
            else if (block == Blocks.wooden_slab)
            {
                item = (new ItemSlab(Blocks.wooden_slab, Blocks.wooden_slab, Blocks.double_wooden_slab, false)).setUnlocalizedName("woodSlab");
            }
            else if (block == Blocks.double_wooden_slab)
            {
                item = (new ItemSlab(Blocks.double_wooden_slab, Blocks.wooden_slab, Blocks.double_wooden_slab, true)).setUnlocalizedName("woodSlab");
            }
            else if (block == Blocks.sapling)
            {
                item = (new ItemMultiTexture(Blocks.sapling, Blocks.sapling, BlockSapling.field_149882_a)).setUnlocalizedName("sapling");
            }
            ...
            {
                item = (new ItemColored(Blocks.tallgrass, true)).func_150943_a(new String[] {"shrub", "grass", "fern"});
            }
            else if (block == Blocks.yellow_flower)
            {
                item = (new ItemMultiTexture(Blocks.yellow_flower, Blocks.yellow_flower, BlockFlower.field_149858_b)).setUnlocalizedName("flower");
            }
            else if (block == Blocks.red_flower)
            {
                item = (new ItemMultiTexture(Blocks.red_flower, Blocks.red_flower, BlockFlower.field_149859_a)).setUnlocalizedName("rose");
            }
            ...
            {
                item = (new ItemMultiTexture(Blocks.cobblestone_wall, Blocks.cobblestone_wall, BlockWall.field_150092_a)).setUnlocalizedName("cobbleWall");
            }
            ...
            {
                item = (new ItemDoublePlant(Blocks.double_plant, Blocks.double_plant, BlockDoublePlant.field_149892_a)).setUnlocalizedName("doublePlant");
            }
            else
            {
            ...
            itemRegistry.addObject(Block.getIdFromBlock(block), var3, item);
        }
    }
	...
	/**
	 * Register tools of the given {@code ToolMaterial}.
	 * It take 5 ids from the first provided.
	 *
	 * @param id
	 * @param material
	 */
	protected static int registerTools(int id, ToolMaterial material)
	{
		String materialId = material.name().toLowerCase();
		String materialName = material.getMaterialName();

		String itemId = materialId + "_sword";
		itemRegistry.addObject(id++, itemId, new ItemSword(material).setUnlocalizedName("sword" + materialName).setTextureName(itemId));
		itemId = materialId + "_pickaxe";
		itemRegistry.addObject(id++, itemId, new ItemPickaxe(material).setUnlocalizedName("pickaxe" + materialName).setTextureName(itemId));
		itemId = materialId + "_shovel";
		itemRegistry.addObject(id++, itemId, new ItemSpade(material).setUnlocalizedName("shovel" + materialName).setTextureName(itemId));
	...
	/**
	 * Register armor of th given {@code ArmorMaterial}.
	 * It take 4 ids from the provided.
	 *
	 * @param id
	 * @param material
	 */
	protected static int registerArmor(int id, ItemArmor.ArmorMaterial material)
	{
		String materialId = material.name().toLowerCase();
		String materialName = material.getMaterialName();

		String itemId = materialId + "_helmet";
		itemRegistry.addObject(id++, itemId, new ItemArmor(material, material.ordinal(), 0).setUnlocalizedName("helmet" + materialName).setTextureName(itemId));
		itemId = materialId + "_chestplate";
		itemRegistry.addObject(id++, itemId, new ItemArmor(material, material.ordinal(), 1).setUnlocalizedName("chestplate" + materialName).setTextureName(itemId));
		itemId = materialId + "_leggings";
		itemRegistry.addObject(id++, itemId, new ItemArmor(material, material.ordinal(), 2).setUnlocalizedName("leggings" + materialName).setTextureName(itemId));
		itemId = materialId + "_boots";
		itemRegistry.addObject(id++, itemId, new ItemArmor(material, material.ordinal(), 3).setUnlocalizedName("boots" + materialName).setTextureName(itemId));
