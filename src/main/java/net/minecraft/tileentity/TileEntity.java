...
public class TileEntity
{
    ...
    {
        this.posX = p_145839_1_.getInteger("x");
        this.posY = p_145839_1_.getInteger("y");
        this.posZ = p_145839_1_.getInteger("z");
    }
    ...
    public void writeToNBT(NBTTagCompound p_145841_1_)
    {
        ...
        else
        {
            ...
            p_145841_1_.setInteger("x", this.posX);
            p_145841_1_.setInteger("y", this.posY);
            p_145841_1_.setInteger("z", this.posZ);
        }
    }
    ...
    public int getBlockMetadata()
    {
        ...
        {
            this.blockMetadata = this.worldObj.getBlockMetadata(this.posX, this.posY, this.posZ);
        }
    ...
    public void onInventoryChanged()
    {
        ...
        {
            this.blockMetadata = this.worldObj.getBlockMetadata(this.posX, this.posY, this.posZ);
            this.worldObj.func_147476_b(this.posX, this.posY, this.posZ, this);

            if (this.getBlockType() != Blocks.air)
            {
                this.worldObj.func_147453_f(this.posX, this.posY, this.posZ, this.getBlockType());
            }
        }
    }
    ...
    {
        double var7 = (double)this.posX + 0.5D - p_145835_1_;
        double var9 = (double)this.posY + 0.5D - p_145835_3_;
        double var11 = (double)this.posZ + 0.5D - p_145835_5_;
    ...
    public Block getBlockType()
    {
        ...
        {
            this.blockType = this.worldObj.getBlock(this.posX, this.posY, this.posZ);
        }
    ...
    public void func_145828_a(CrashReportCategory p_145828_1_)
    {
        ...
        CrashReportCategory.func_147153_a(p_145828_1_, this.posX, this.posY, this.posZ, this.getBlockType(), this.getBlockMetadata());
        p_145828_1_.addCrashSectionCallable("Actual block type", new Callable()
        {
            public String call()
            {
                int var1 = Block.getIdFromBlock(TileEntity.this.worldObj.getBlock(TileEntity.this.posX, TileEntity.this.posY, TileEntity.this.posZ));
        ...
        p_145828_1_.addCrashSectionCallable("Actual block data value", new Callable()
        {
            public String call()
            {
                int var1 = TileEntity.this.worldObj.getBlockMetadata(TileEntity.this.posX, TileEntity.this.posY, TileEntity.this.posZ);
    ...
    static
    {
        ...
        func_145826_a(TileEntityWaterPipe.class, "WaterPipe");
    }
}
