...
public class TileEntityEnderChest extends TileEntity
{
    ...
    public void updateEntity()
    {
        ...
        {
            this.worldObj.func_147452_c(this.posX, this.posY, this.posZ, Blocks.ender_chest, 1, this.field_145973_j);
        }
        ...
        {
            double var2 = (double)this.posX + 0.5D;
            var4 = (double)this.posZ + 0.5D;
            this.worldObj.playSoundEffect(var2, (double)this.posY + 0.5D, var4, "random.chestopen", 0.5F, this.worldObj.rand.nextFloat() * 0.1F + 0.9F);
        }
        ...
        if (this.field_145973_j == 0 && this.field_145972_a > 0.0F || this.field_145973_j > 0 && this.field_145972_a < 1.0F)
        {
            ...
            {
                var4 = (double)this.posX + 0.5D;
                double var6 = (double)this.posZ + 0.5D;
                this.worldObj.playSoundEffect(var4, (double)this.posY + 0.5D, var6, "random.chestclosed", 0.5F, this.worldObj.rand.nextFloat() * 0.1F + 0.9F);
            }
    ...
    {
        return this.worldObj.getTileEntity(this.posX, this.posY, this.posZ) != this ? false : p_145971_1_.getDistanceSq((double)this.posX + 0.5D, (double)this.posY + 0.5D, (double)this.posZ + 0.5D) <= 64.0D;
    }
}
