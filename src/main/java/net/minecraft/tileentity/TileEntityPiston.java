...
public class TileEntityPiston extends TileEntity
{
    ...
    private void func_145863_a(float p_145863_1_, float p_145863_2_)
    {
        ...
        AxisAlignedBB var3 = Blocks.piston_extension.func_149964_a(this.worldObj, this.posX, this.posY, this.posZ, this.field_145869_a, p_145863_1_, this.field_145874_j);
    ...
    public void func_145866_f()
    {
        if (this.field_145870_n < 1.0F && this.worldObj != null)
        {
            ...
            this.worldObj.removeTileEntity(this.posX, this.posY, this.posZ);
            this.invalidate();

            if (this.worldObj.getBlock(this.posX, this.posY, this.posZ) == Blocks.piston_extension)
            {
                this.worldObj.setBlock(this.posX, this.posY, this.posZ, this.field_145869_a, this.field_145876_i, 3);
                this.worldObj.func_147460_e(this.posX, this.posY, this.posZ, this.field_145869_a);
            }
        }
    }
