...
public class EntityPlayerMP extends EntityPlayer implements ICrafting
{
    ...
    public void func_146100_a(TileEntity p_146100_1_)
    {
        if (p_146100_1_ instanceof TileEntitySign)
        {
            ...
            this.playerNetServerHandler.sendPacket(new S36PacketSignEditorOpen(p_146100_1_.posX, p_146100_1_.posY, p_146100_1_.posZ));
        }
    }
    ...
    public void displayGUIHopper(TileEntityHopper p_146093_1_)
    {
        this.getNextWindowId();
    ...
    public void displayGUIFurnace(TileEntityFurnace p_146101_1_)
    {
        this.getNextWindowId();
        this.playerNetServerHandler.sendPacket(new S2DPacketOpenWindow(this.currentWindowId, 2, p_146101_1_.getInventoryName(), p_146101_1_.getSizeInventory(), p_146101_1_.isInventoryNameLocalized(), p_146101_1_.furnaceSpeed));
        this.openContainer = new ContainerFurnace(this.inventory, p_146101_1_);
        this.openContainer.windowId = this.currentWindowId;
        this.openContainer.addCraftingToCrafters(this);
    }

    public void displayGUIDispenser(TileEntityDispenser p_146102_1_)
    {
        this.getNextWindowId();
    ...
    public void displayGUIBrewingStand(TileEntityBrewingStand p_146098_1_)
    {
        this.getNextWindowId();
    ...
    public void displayGUIBeacon(TileEntityBeacon p_146104_1_)
    {
        this.getNextWindowId();
    ...
    @Override
    public void displayGUIWaterPipe(TileEntityWaterPipe waterPipe) {
        this.getNextWindowId();
        this.playerNetServerHandler.sendPacket(new S2DPacketOpenWindow(this.currentWindowId, 12, waterPipe.getInventoryName(), waterPipe.getSizeInventory(), waterPipe.isInventoryNameLocalized()));
        this.openContainer = new ContainerWaterPipe(this.inventory, waterPipe);
        this.openContainer.windowId = this.currentWindowId;
        this.openContainer.addCraftingToCrafters(this);
    }
