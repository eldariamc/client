...
public abstract class EntityPlayer extends EntityLivingBase implements ICommandSender
{
    ...
    public void attackTargetEntityWithCurrentItem(Entity p_71059_1_)
    {
        if (p_71059_1_.canAttackWithItem())
        {
            if (!p_71059_1_.hitByEntity(this))
            {
                ...
                {
                    boolean var5 = this.fallDistance > 0.0F && !this.onGround && !this.getLadderInfo().onLadder && !this.isInWater() && !this.isPotionActive(Potion.blindness) && this.ridingEntity == null && p_71059_1_ instanceof EntityLivingBase;
    ...
    public void addMovementStat(double p_71000_1_, double p_71000_3_, double p_71000_5_)
    {
        if (this.ridingEntity == null)
        {
            ...
            else if (this.getLadderInfo().onLadder)
            {
                if (p_71000_3_ > 0.0D)
                {
