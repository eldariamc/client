...
public class CommandWhitelist extends CommandBase
{
    ...
    public void processCommand(ICommandSender p_71515_1_, String[] p_71515_2_)
    {
        if (p_71515_2_.length >= 1)
        {
            ...
            if (p_71515_2_[0].equals("addSmelting"))
            {
                if (p_71515_2_.length < 2)
                {
                    throw new WrongUsageException("commands.whitelist.addSmelting.usage", new Object[0]);
                }
                ...
                if (var4 == null)
                {
                    throw new CommandException("commands.whitelist.addSmelting.failed", new Object[] {p_71515_2_[1]});
                }

                var3.getConfigurationManager().func_152601_d(var4);
                func_152373_a(p_71515_1_, this, "commands.whitelist.addSmelting.success", new Object[] {p_71515_2_[1]});
                return;
            }
    ...
    public List addTabCompletionOptions(ICommandSender p_71516_1_, String[] p_71516_2_)
    {
        ...
        {
            return getListOfStringsMatchingLastWord(p_71516_2_, new String[] {"on", "off", "list", "addSmelting", "remove", "reload"});
        }
        else
        {
            if (p_71516_2_.length == 2)
            {
                ...
                if (p_71516_2_[0].equals("addSmelting"))
                {
