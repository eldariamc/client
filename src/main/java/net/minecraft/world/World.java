...
public abstract class World implements IBlockAccess
{
    ...
    public void updateEntities()
    {
        ...
        while (var9.hasNext())
        {
            ...
            if (!var10.isInvalid() && var10.hasWorldObj() && this.blockExists(var10.posX, var10.posY, var10.posZ))
            {
                try
                {
                    var10.updateEntity();
            ...
            if (var10.isInvalid())
            {
                ...
                if (this.chunkExists(var10.posX >> 4, var10.posZ >> 4))
                {
                    Chunk var12 = this.getChunkFromChunkCoords(var10.posX >> 4, var10.posZ >> 4);

                    if (var12 != null)
                    {
                        var12.removeTileEntity(var10.posX & 15, var10.posY, var10.posZ & 15);
                    }
                }
            }
        }
        ...
        if (!this.field_147484_a.isEmpty())
        {
            for (int var11 = 0; var11 < this.field_147484_a.size(); ++var11)
            {
                ...
                if (!var13.isInvalid())
                {
                    ...
                    if (this.chunkExists(var13.posX >> 4, var13.posZ >> 4))
                    {
                        Chunk var15 = this.getChunkFromChunkCoords(var13.posX >> 4, var13.posZ >> 4);

                        if (var15 != null)
                        {
                            var15.func_150812_a(var13.posX & 15, var13.posY, var13.posZ & 15, var13);
                        }
                    }

                    this.markBlockForUpdate(var13.posX, var13.posY, var13.posZ);
                }
            }
        ...
        if (p_147438_2_ >= 0 && p_147438_2_ < 256)
        {
            ...
            if (this.field_147481_N)
            {
                for (var5 = 0; var5 < this.field_147484_a.size(); ++var5)
                {
                    ...
                    if (!var6.isInvalid() && var6.posX == p_147438_1_ && var6.posY == p_147438_2_ && var6.posZ == p_147438_3_)
                    {
                        var4 = var6;
                        break;
                    }
    ...
    public void setTileEntity(int p_147455_1_, int p_147455_2_, int p_147455_3_, TileEntity p_147455_4_)
    {
        if (p_147455_4_ != null && !p_147455_4_.isInvalid())
        {
            if (this.field_147481_N)
            {
                p_147455_4_.posX = p_147455_1_;
                p_147455_4_.posY = p_147455_2_;
                p_147455_4_.posZ = p_147455_3_;
                ...
                while (var5.hasNext())
                {
                    ...
                    if (var6.posX == p_147455_1_ && var6.posY == p_147455_2_ && var6.posZ == p_147455_3_)
                    {
                        var6.invalidate();
                        var5.remove();
                    }
