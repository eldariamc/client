...
public class ArmorStatusHUD {
   ...
   private static String damageColorListDefault = "100,f; 80,7; 60,e; 40,6; 25,c; 10,4";
   ...
   static final List colorList = new ArrayList();
   ...
   public static void syncConfig() {
      ...
      try {
         ...
         Reference.LOGGER.log(Level.WARNING, "Error encountered parsing damageColorList: " + damageColorList);
         Reference.LOGGER.log(Level.WARNING, "Reverting to defaultColorList: 100,f; 80,7; 60,e; 40,6; 25,c; 10,4");
   ...
   public static int countOfDisplayableItems(EntityPlayer player) {
      int i = 0;
      i = i + (canDisplayItem(player.inventory.armorItemInSlot(0))?1:0);
      i = i + (canDisplayItem(player.inventory.armorItemInSlot(1))?1:0);
      i = i + (canDisplayItem(player.inventory.armorItemInSlot(2))?1:0);
      i = i + (canDisplayItem(player.inventory.armorItemInSlot(3))?1:0);
      i = i + (showEquippedItem && canDisplayItem(player.getCurrentEquippedItem())?1:0);
      return i;
   }
